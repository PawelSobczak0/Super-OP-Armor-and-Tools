...
public class OP_ToolAxeItem extends SuperArmorAndToolsModElements.ModElement {
	@ObjectHolder("super_armor_and_tools:op_tool_axe")
	public static final Item block = null;

	public OP_ToolAxeItem(SuperArmorAndToolsModElements instance) {
		super(instance, 2);
	}
